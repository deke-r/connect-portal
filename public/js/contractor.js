    ...
    function updateCount() {
        ...
        if (count >= 60 && count <= 60) {
            Swal.fire({
                icon: "error",
                title: "",
                html: `<h5 class='fw-600'>Press "YES": More than 60 contractors can be entered & approval will go to respective BM/ASM.</h5><br>
                <h5 class='fw-600'>Press "NO": Maximum 60 contractors can be entered & BTL will be automatically approved.</h5>
                `,
